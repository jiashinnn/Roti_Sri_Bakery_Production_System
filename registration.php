...
if (isset($_POST['submit'])) {
  ...
  $sqlregister = "INSERT INTO `tbl_users`(`user_fullName`, `user_contact`, `user_address`, `user_email`, `user_password`) 
VALUES (:fullname, :phone, :address, :email, :password)";
  ...
  if ($LastInsertId > 0) {
    ...
    $mail->setFrom($email, "YSLProduction | Production System");
    $mail->addAddress($_POST["email"], $_POST['fullname']);

    $mail->Subject = "Welcome to YSLProduction";
    $mail->Body = "Dear $fullname,

Thank you for registering with YSLProduction.
...
<head>
  <title>YSLProduction | Registration </title>
  ...
  <div class="contact">
    ...
    <div class="container">
      <div class="contact-info">
        <h3 class="c-text">Welcome Production Team. Register Here</h3>
      </div>
      ...
      <div class="contact-grids">
        <form class="forms-sample" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input style="width:50%;" type="text" name="phone" class="form-control" required='true'>
          </div>
          <div class="form-group">
            <label for="exampleInputAddress">Address</label>
            <textarea style="width:50%;" name="address" class="form-control" required='true'></textarea>
          </div>
          <!-- <div class="form-group">
